...
void main(void)
{
	...
	matlist[0] = in_mat1 / 255;
	matlist[1] = in_mat2 / 255;
	matlist[2] = in_mat3 / 255;
	matlist[3] = in_mat4 / 255;
	matlist[4] = in_mat5 / 255;
	matlist[5] = in_mat6 / 255;
	matlist[6] = in_mat7 / 255;
	matlist[7] = in_mat8 / 255;
	matlist[8] = in_mat9 / 255;
	matlist[9] = in_mat10 / 255;
	matlist[10] = in_mat11 / 255;
	matlist[11] = in_mat12 / 255;
}